...
const texts = {
    subtitleText: {
        ...
        <br> Yaklaşık iki yıldır <b>front-end teknolojileri</b> ile uğraşıyorum.<br> 
        Fotoğrafçılığa, kitaplara ve filmlere ilgim var. <br>
        <b>Web ve mobil geliştirme</b> üzerine çalışıyorum<br>
        <br> Benim hakkımda daha fazla bilgi almak için lütfen bana ulaşın.`,
        en: `Hi, my name is <b>Gizem.</b><br>
        I'm interested in <b>front-end technologies </b> almost two year.<br>
        I'm working on <b> web and mobile development.</b><br>
        Also I like photography, books and movies. <br>
